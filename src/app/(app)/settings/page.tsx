      ...
      <div className="space-y-6 max-w-3xl">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-on-surface/65 font-sans">ananya@example.com</p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-primary/5">
              <div className="space-y-1">
                <p className="text-[11px] font-bold uppercase tracking-wider text-on-surface/60">Monthly Income</p>
                <p className="font-bold text-primary">₹85,000</p>
              </div>
              <div className="space-y-1">
                <p className="text-[11px] font-bold uppercase tracking-wider text-on-surface/60">Risk Profile</p>
                <p className="font-bold text-primary">Moderate</p>
              </div>
            </div>
            <div className="pt-2">
              <span className="text-xs text-on-surface/60 font-sans italic">Profile editing coming soon with account setup.</span>
            </div>
          </div>
        </Card>
            ...
            {[
              ...
              <div key={item.label} className="flex items-center justify-between py-2 border-b border-primary/5 last:border-0">
                <div>
                  ...
                  <p className="text-xs text-on-surface/65 font-sans mt-0.5">{item.desc}</p>
                </div>
                <span className="text-[11px] font-bold uppercase tracking-wider text-on-surface/60 bg-surface-low border border-primary/5 px-3 py-1 rounded-full shrink-0 ml-4">
                  Soon
                </span>
              </div>
            ))}
        ...
        <Card variant="default" padding="xl">
          ...
          <div className="border-2 border-dashed border-primary/10 rounded-2xl p-8 text-center space-y-3">
            <p className="font-sans text-sm text-on-surface/60 font-medium">No accounts connected yet</p>
            <p className="font-sans text-xs text-on-surface/55">Connect your first account to unlock live data</p>
          </div>
          <div className="mt-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-2 border-b border-primary/5">
              <div>
                ...
                <p className="text-xs text-on-surface/65 font-sans mt-0.5">Display currency for all values</p>
              </div>
            ...
            <div className="flex items-center justify-between py-2 border-b border-primary/5">
              <div>
                ...
                <p className="text-xs text-on-surface/65 font-sans mt-0.5">Interface display language</p>
              </div>
            ...
            <div className="flex items-center justify-between py-2">
              <div>
                ...
                <p className="text-xs text-on-surface/65 font-sans mt-0.5">Dark mode coming soon</p>
              </div>
