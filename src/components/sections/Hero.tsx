      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-6 space-y-7 text-left">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
            <a
              href="#wellness"
              className="bg-primary text-white px-8 py-4 rounded-xl font-sans text-sm font-semibold tracking-wider hover:bg-primary-container transition-all active:scale-[0.98] duration-200 shadow-xl shadow-primary/10 hover:shadow-primary/20 text-center"
            >
              Join the Circle
            </a>
            <a
              href="#advisor"
              className="border border-primary/15 px-8 py-4 rounded-xl font-sans text-sm font-semibold tracking-wider hover:bg-surface-low text-primary transition-colors text-center"
            >
              Explore Features
            </a>
          </div>
        ...
        <div className="lg:col-span-6 relative">
          <div className="relative z-10 glass-card p-6 md:p-8 rounded-[2rem] shadow-2xl border border-white/50 backdrop-blur-3xl">
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="flex flex-col items-end gap-1">
                <span className="bg-primary/5 text-primary border border-primary/10 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1">
